...
class ApplicationRequestTransferOutCreator
{
    /**
     * @var CommandBus
     */
        ...
        try {
            if (isset($data['applicationRequest'])) {
                ...
                if ($applicationRequest instanceof ApplicationRequest) {
                    ...
                    return [
                        'FRCContractTransferOutNumber' => $applicationRequest->getExternalApplicationRequestNumber(),
                        'CRMContractTransferOutNumber' => $applicationRequest->getApplicationRequestNumber(),
                        'ProcessStatus' => 1,
            ...
            return [
                'FRCContractTransferOutNumber' => 'No data.' !== $ex->getMessage() ? $data['applicationRequest']['externalApplicationRequestNumber'] : '',
