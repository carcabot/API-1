...
namespace App\WebService\SMS\Provider\FortDigital\Controller;
    ...
    public function __invoke(ServerRequestInterface $request): Response
    {
        ...
        try {
            ...
            $outboundActivitySMSHistories = $qb->join('a.outboundSMS', 'sms')
                ...
                ->andWhere($expr->eq('sms.provider', $expr->literal(SMSWebServicePartner::FORT_DIGITAL)))
            ...
            $smsHistory->setProvider(new SMSWebServicePartner(SMSWebServicePartner::FORT_DIGITAL));
