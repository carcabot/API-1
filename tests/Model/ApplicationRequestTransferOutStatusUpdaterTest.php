...
class ApplicationRequestTransferOutStatusUpdaterTest extends TestCase
{
    public function testProcessArrayData()
    {
        ...
        $data2 = [];
        $data2['applicationRequest']['asd'] = 'asd';
        ...
        $applicationRequestTransferOutStatusUpdater = new ApplicationRequestTransferOutStatusUpdater($commandBus, $entityManager);
        $actualOutput = $applicationRequestTransferOutStatusUpdater->processArrayData([$data, $data2]);
        $expectedOutput = [$data2];
