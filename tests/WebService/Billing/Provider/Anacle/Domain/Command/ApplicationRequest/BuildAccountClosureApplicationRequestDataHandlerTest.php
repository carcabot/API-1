...
use App\WebService\Billing\Provider\Anacle\Domain\Command\ApplicationRequest\BuildAccountClosureApplicationRequestDataHandler;
use App\WebService\Billing\Services\DataMapper;
use PHPUnit\Framework\TestCase;

class BuildAccountClosureApplicationRequestDataHandlerTest extends TestCase
{
    public function testRefundeeAccountTypeIsINDIVIDUAL()
    {
        ...
        $expectedTransferOutRequestData = [
            'CRMContractClosureNumber' => 'ARN123456789',
            'FRCContractNumber' => 'CN123456789',
            'RequestContractClosureDate' => $now->format('Ymd'),
        ...
        $buildAccountClosureApplicationRequestData = new BuildAccountClosureApplicationRequestData($applicationRequest);
        ...
        $buildAccountClosureApplicationRequestDataHandler = new BuildAccountClosureApplicationRequestDataHandler($dataMapperProphecy);
        $actualTransferOutRequestData = $buildAccountClosureApplicationRequestDataHandler->handle($buildAccountClosureApplicationRequestData);
    ...
    public function testRefundeeAccountTypeIsIndividualWithSomeNullValues()
    {
        ...
        $expectedTransferOutRequestData = [
            ...
            'RequestContractClosureDate' => null,
            'Remarks' => 'shaboo remarks',
            'Deposit' => null,
            'DifferentPayeeIndicator' => true,
