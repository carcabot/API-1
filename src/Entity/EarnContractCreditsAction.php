...
/**
 * The act of earning credits for a contract.
 *
 * @ORM\Entity(repositoryClass="App\Repository\EarnContractCreditsActionRepository")
 * @ApiResource(attributes={
 *     "normalization_context"={"groups"={"earn_contract_credits_action_read"}},
 *     "denormalization_context"={"groups"={"earn_contract_credits_action_write"}},
 *     "filters"={
 *         "earn_contract_credits_action.order",
 *         "earn_contract_credits_action.date",
 *         "earn_contract_credits_action.search",
 *     },
 * })
 */
class EarnContractCreditsAction extends UpdateCreditsAction implements CreditsAdditionInterface
{
    /**
