...
/**
 * The act of earning affiliate credits for a customer.
 *
 * @ORM\Entity
 * @ApiResource(attributes={
 *     "normalization_context"={"groups"={"earn_customer_affiliate_credits_action_read"}},
 *     "denormalization_context"={"groups"={"earn_customer_affiliate_credits_action_write"}}
 * })
 */
class EarnCustomerAffiliateCreditsAction extends UpdateCreditsAction implements CreditsAdditionInterface
{
    /**
     ...
     * @ORM\JoinTable(
     *     name="earn_customer_affiliate_credits_transactions",
     *     joinColumns={@ORM\JoinColumn(name="earn_customer_affiliate_credits_action_id", onDelete="CASCADE")},
     *     inverseJoinColumns={@ORM\JoinColumn(name="affiliate_program_transaction_id", onDelete="CASCADE")}
     * )
     * @ORM\OrderBy({"id"="ASC"})
     * @ApiProperty()
     * @ApiSubresource()
