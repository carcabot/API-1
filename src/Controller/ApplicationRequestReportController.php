...
class ApplicationRequestReportController
{
    /**
    ...
    public function __invoke(ServerRequestInterface $request)
    {
        ...
        $document->setType(new DocumentType(DocumentType::APPLICATION_REQUEST_REPORT));
        ...
        $job = new DisqueJob([
            ...
            'type' => JobType::APPLICATION_REQUEST_REPORT_GENERATE,
        ]);
