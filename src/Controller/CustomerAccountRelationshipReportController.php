...
class CustomerAccountRelationshipReportController
{
    /**
    ...
    public function __invoke(ServerRequestInterface $request)
    {
        ...
        $document->setType(new DocumentType(DocumentType::CUSTOMER_ACCOUNT_RELATIONSHIP_REPORT));
        ...
        $job = new DisqueJob([
            ...
            'type' => JobType::CUSTOMER_ACCOUNT_RELATIONSHIP_REPORT_GENERATE,
        ]);
