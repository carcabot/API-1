...
/**
 * DQL function to parse text to tsquery that searches for a phrase.
 *
 * "phraseto_tsquery" "(" [ArithmeticExpression ","] ArithmeticExpression ")"
 */
class PhraseToTsqueryFunction extends FunctionNode
{
    protected $config;
    protected $query;
