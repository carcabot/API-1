...
class LeadEmailActivityAdditionListener
{
    /**
     * @var DisqueQueue
     */
    ...
    public function onKernelRequest(GetResponseEvent $event)
    {
        ...
        $this->initialActivities->put($lead, $lead->getActivities());
    }
    ...
    public function onKernelView(GetResponseForControllerResultEvent $event)
    {
        ...
        if (Request::METHOD_POST === $request->getMethod()) {
            ...
            $activities = $lead->getActivities();
            $prevActivities = $this->initialActivities->get($lead, null);
    ...
    private function pushToDisqueueQueue(EmailActivity $activity)
    {
        $job = new DisqueJob([
            ...
            'type' => JobType::LEAD_EMAIL_ACTIVITY_CREATED,
            'activity' => [
