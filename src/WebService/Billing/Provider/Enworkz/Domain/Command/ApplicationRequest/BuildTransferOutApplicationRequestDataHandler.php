...
class BuildTransferOutApplicationRequestDataHandler
{
    /**
     * @var DataMapper
     */
    ...
    public function handle(BuildTransferOutApplicationRequestData $command): array
    {
        ...
        $transferOutRequestData += $addressData;

        return $transferOutRequestData;
    }
}
